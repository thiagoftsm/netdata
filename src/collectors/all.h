...
#define NETDATA_CHART_PRIO_MEM_SYSTEM_PAGE_LISTS      1041 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_CACHE           1042 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_POOL_ALLOCS     1043 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_POOL_PAGED      1044 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_CODE            1045 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_DRIVERS         1046 // Windows only
...
#define NETDATA_CHART_PRIO_MEM_SYSTEM_PGFAULTS_DETAIL 1051 // Windows only
#define NETDATA_CHART_PRIO_MEM_SYSTEM_TRANSITION      1052 // Windows only
...
#define NETDATA_CHART_PRIO_SENSOR_RESISTANCE         70013
