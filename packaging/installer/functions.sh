...
prepare_cmake_options() {
  # Extra cmake options that may contain paths with spaces are kept in an array
  # so each element is passed as a single quoted argument to cmake and escaped_print.
